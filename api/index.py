...
def update_hero(id):
    ...
    WHERE id = %s
    """
    cursor.execute(sql, (updated_data['nombre'], updated_data['habilidad'], updated_data['compania'], updated_data['genero'], updated_data['descripcion'], update_data['imagen'],id))
    connection.commit()
    cursor.close()
    connection.close()
